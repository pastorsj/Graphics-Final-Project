...
GLuint ShaderManager::shaderFromFile(char const * const * vertShaderPath, char const * const * fragShaderPath, int const vertShaderCount, int const fragShaderCount)
{
	return ShaderManager::readAndBuildProgram(vertShaderPath, fragShaderPath, vertShaderCount, fragShaderCount);
}

GLuint ShaderManager::shaderFromString(char const * const * vertShaderSource, char const * const * fragShaderSource, int const vertShaderCount, int const fragShaderCount)
{
	return createShaderProgram(vertShaderSource, fragShaderSource, vertShaderCount, fragShaderCount);
}

GLuint ShaderManager::readAndBuildProgram(char const * const * vertShaderPath, char const * const * fragShaderPath, int const vertShaderCount, int const fragShaderCount)
{
#ifndef MAX_SHADERS
...
GLuint ShaderManager::createShaderProgram(char const * const * vertSource, char const * const * fragSource, int const vertShaderCount, int const fragShaderCount)
{
#ifndef MAX_SHADERS
#define MAX_SHADERS 10
#endif
...
void ShaderManager::printShaderInfoLog(GLuint obj, int const shaderCount)
{
	int infologLength = 0;
	int charsWritten = 0;
	char *infoLog;
...
void ShaderManager::printProgramInfoLog(GLuint obj, int const vertShaderCount, int const fragShaderCount)
{
	int infologLength = 0;
	int charsWritten = 0;
	char *infoLog;
...
FILE* ShaderManager::sfopen(const char* name, const char *mode)
{
	FILE *file = NULL;
...
char* ShaderManager::readFile(char const * fileName)
{
	FILE *file;
